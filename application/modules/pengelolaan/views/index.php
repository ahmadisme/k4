            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        ...
                        <div class="col ml--2">
                            <h4 class="mb-0">
                                <a href="#!">Belum bisa Proses</a>
                            </h4>
                            <p class="text-xl text-default mb-0">
                                <font style="font-weight: bold;"><?= $jumlah_tb->belum ?></font>
                            </p>
                            <span class="text-success">●</span>
                            <small>Active</small>
                        </div>
                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        ...
                        <div class="col ml--2">
                            ...
                            <p class="text-xl text-default mb-0">
                                <font style="font-weight: bold;"><?= $jumlah_tb->proses ?></font>
                            </p>
                            <span class="text-success">●</span>
                            <small>Active</small>
                        </div>
                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        ...
                        <div class="col ml--2">
                            ...
                            <p class="text-xl text-default mb-0">
                                <font style="font-weight: bold;"><?= $jumlah_tb->sudah_bast ?></font>
                            </p>
                            <span class="text-success">●</span>
                            <small>Active</small>
                        </div>
