<!-- Header -->
<div class="header pb-6 d-flex align-items-center" style="min-height: 400px; background-image: url(<?= base_url('assets/img/gdg.jpeg') ?>); background-size: cover; background-position: center top;">
    <!-- Mask -->
