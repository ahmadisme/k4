                        ...
                        <div class="col-12">
                            <div class="nav-wrapper">
                                <ul class="nav nav-pills nav-fill flex-column flex-md-row " id="tabs-icons-text" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link mb-sm-3 mb-md-0 lebar100 bg-gradient-info" id="tabs-icons-text-3-tab" data-toggle="tab" href="#tabs-icons-text-3" role="tab" aria-controls="tabs-icons-text-3" aria-selected="false"><img src="<?= base_url('assets') ?>/img/flat.png" width="42" height="50">
                                            <h3>
                                ...
                                <tbody>
                                    <?php foreach ($penerima_manfaat as $pm) { ?>
                                        <tr>
                                            ...
                                            <td><?= $pm->huni ?></td>
                                            <td><?= $pm->belum_huni ?></td>
                                            <td><a href="<?= base_url('penghunian/penghunian_provinsi_penerima_manfaat/') . $pm->id_provinsi ?>/<?= $pm->id_penerima_manfaat ?>" type="button" class="btn btn-default btn-sm">Detail</a></td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
                            </table>
