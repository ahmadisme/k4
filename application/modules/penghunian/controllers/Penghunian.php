...
class Penghunian extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['tb_tahun_anggaran'] = $this->db->query('SELECT * FROM tb_bangunan GROUP BY penerima_manfaat')->result();
        $data['tb_penerima_manfaat'] = $this->db->get('tb_penerima_manfaat')->result();
